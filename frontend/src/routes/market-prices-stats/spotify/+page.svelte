    ...
    <div class="container" style="margin-top: 1%;">
        {#if show_token_section == true}
            <div class="row" style="margin-bottom: 1%;">
                ...
                <p>
                    Para poder usar esta funcionalidad, tienes que ir a la página de desarrolladores de spotify: <a href="https://developer.spotify.com/dashboard/applications">https://developer.spotify.com/dashboard/applications</a>, crear un APP para obtener el Client Id y Secret y añadir <strong>https://sos2223-21.ew.r.appspot.com/market-prices-stats/spotify</strong> en el campo "Redirect URIs".
                </p>
            </div>
            <Form>
                <FormGroup>
